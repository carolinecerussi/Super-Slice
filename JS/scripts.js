...
function handleOrder(event) {
  ...
  document.querySelector("span#summary").innerText = ("Size: " + sizeChosen + "</n>"+ "Toppings: " + toppingsChosen + "Pick up or Delivery:  " + "<br />"+ diningChosen + "<br />"+  "   Tip Amount: " + tipChosen + "%" + "Order Total: $" + cost);
